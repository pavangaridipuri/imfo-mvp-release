      ...
      <ScrollView style={styles.wrapper}>
        <View style={styles.welcomeWrapper}>
         {/* <Image
            ...
            style={styles.logo}
          /> */}
          <Text style={styles.welcomeText}>Is My Family Okay?</Text>
          <RoundedButton
            text="Continue with Facebook"
            textColor={colors.white}
            background={colors.pink}
            Ionicons={<Ionicons name="logo-facebook" size={20} style={styles.facebookButtonIonicons}/>}
            //handleOnPress={this.onFacebookPress}
            handleOnPress={() => this.props.navigation.dispatch(navigateToTabsAction)}
